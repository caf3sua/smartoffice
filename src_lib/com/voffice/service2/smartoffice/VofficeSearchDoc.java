...
public class VofficeSearchDoc {
    ...
    private static void searchDoc() throws JSONException {
...
//        params.put("type", "3");
        ...
        params.put("type", "1");
        params.put("isCount", "2");
//        JSONArray jsonArray = new JSONArray();
//        JSONObject json1 = new JSONObject();
//        json1.put("title", "Phiếu giao việc tháng 04/2017 - đ/c Bùi Trường Vinh");
//        json1.put("code", "170/PGV_PM1TTVPDT_201704");
        
        DocumentEntity obj = new DocumentEntity();
        obj.setTitle("8:31 hongntl chuyển văn bản thường cho nhóm");
        //obj.setContent("aaaa");
        obj.setDocumentId(391177l);
...
//        jsonArray.put(json1);
        ...
        String data = FunctionCommon.getItemInJson("result", dataRequest)
                    .toString();
        System.out.println("DocumentAction.search-errorCode=" + errorCode);
