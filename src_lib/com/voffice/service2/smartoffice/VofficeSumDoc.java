...
public class VofficeSumDoc {
    ...
    public static void main(String[] args) throws Exception {
        ...
        getCountTextDashboard();
    }
    
     private static void getCountTextDashboard() throws JSONException {

		System.out.println();
		System.out.println("----------------- textAction.getCountTextDashboard ------------------");
		Map<String, Object> params = new LinkedHashMap<String, Object>();
//                params.put("fromDate", "02/02/2017");
//		params.put("toDate", "16/02/2017");
		//params.put("type", "3");
		//params.put("status", "0");
		...
		System.out.println("textAction.getCountTextDashboard-errorCode=" + errorCode);
